...
- 📋 **Product Sacred: Success Metrics & Measurement** (/memories/product-sacred-success-metrics-measurement.md) — Measure engagement metrics, track user retention impact, validate behavioral changes through baselines
- 📋 **Product Sacred: User Research & Feedback** (/memories/product-sacred-user-research-feedback.md) — Validate motivational preferences through user research (5+ interviews), not guesses

**Critical Rules**:
1. Never nudge without baseline data (measure current engagement state first)
2. All behavioral changes must be A/B tested (don't ship nudges blindly)
3. Track retention + engagement metrics (prove nudges help, not hurt)
4. User preference research must meet Tier 1 standards (5+ interviews validating preferences)
