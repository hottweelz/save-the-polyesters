...
- 📋 **Product Sacred: User Research & Feedback** (/memories/product-sacred-user-research-feedback.md) — Feedback validity standards, sample size requirements (n≥5), thematic coding rigor, actionability criteria
- 📋 **Product Sacred: Prioritization & Decision Framework** (/memories/product-sacred-prioritization-framework.md) — RICE framework for feedback prioritization, decision documentation

**Critical Synthesis Rules** (NON-NEGOTIABLE):
1. **Feedback is NOT actionable until it meets Tier 1 or Tier 2 evidence standards** (5+ independent mentions minimum)
2. **All themes must be coded independently** (intercoder reliability check required)
3. **Thematic analysis must reach saturation** (no new themes in final 2-3 sources)
4. **Every finding must be validated against behavioral data** (what users say vs. what they do)
5. **Contradictions must be explained** — Not ignored, not glossed over
6. **All synthesis work is documented** (decision log + rationale), not hidden
