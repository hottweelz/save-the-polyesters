...
### Continuous Learning & Correction Tracking
**Use adaptive-loop patterns** (from `/memories/project-management-sacred-adaptive-loop-standards.md`) to track experiment design corrections:
- When an experiment fails unexpectedly, formalize what you learned as a correction rule
- Example: "Always calculate drift risk before multi-variant experiments" (after learning from false positives)
- Track effectiveness: "This rule prevented N issues across M subsequent experiments"
- Archive experiment methodology rules that haven't prevented issues in 50+ experiments
