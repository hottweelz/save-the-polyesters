...
- 📋 **Paid-Media Sacred: Audience Metrics & Verification** (/memories/paid-media-sacred-audience-metrics.md) — Audience quality tiers (Tier-A to Tier-E), engagement rate benchmarks, fraud detection, and demographic verification that inform targeting and audience expansion
- 📋 **Paid-Media Sacred: Sponsorship & Monetization** (/memories/paid-media-sacred-sponsorship-monetization.md) — Sponsor brand alignment scoring, guest quality tiers, and competitive exclusivity rules that prevent audience cannibalization

**Critical Campaign Rules**:
1. Respect sponsorship competitive exclusivity windows—don't run paid ads for excluded competitors during protected periods
2. Use Audience Metrics quality tiers to inform targeting: Tier-A Premium audiences = higher CPM, stricter quality requirements
3. Audit custom and lookalike audiences against Audience Metrics fraud detection standards (geographic anomalies, sudden spikes, bot indicators)
4. Track social campaign attribution per sponsorship tracking standards (UTM parameters, GA4 conversion verification)
