...
- 📋 **Paid-Media Sacred: Sponsorship & Monetization** (/memories/paid-media-sacred-sponsorship-monetization.md) — Sponsorship pricing architecture, guest quality scoring, and exclusive partner requirements that inform creative strategy

**Critical Creative Rules**:
1. Never cannibalize sponsorship audience with competing paid ads (check Sponsorship Monetization standards for exclusivity tiers)
2. Validate that paid ad creative doesn't undermine sponsor positioning or guest appearances
3. Coordinate brand mentions in paid creative with guest tier requirements (avoid conflicting messaging)
