...
- 📋 **Product Sacred: User Research & Feedback** (/memories/product-sacred-user-research-feedback.md) — Research validity standards, when to trust secondary research vs. primary research
- 📋 **Product Sacred: Prioritization & Decision Framework** (/memories/product-sacred-prioritization-framework.md) — Trend insights must feed into RICE scoring (not just "competitor did it")

**Critical Research Rules**:
1. **Trends must be validated, not just observed** (secondary research ≠ product decision)
2. **All trend claims must be sourced** (2+ independent sources minimum)
3. **Competitive intelligence is context, not strategy** (customers validating demand is strategy)
4. **Market timing is hypothesis** (test with pilot before full commitment)
5. **All research must feed into prioritization framework** (not just pretty dashboards)
