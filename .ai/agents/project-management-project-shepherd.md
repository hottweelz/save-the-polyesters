...
### Continuous Learning & Project Coordination Corrections
**Use adaptive-loop patterns** (from `/memories/project-management-sacred-adaptive-loop-standards.md`) to track coordination learnings:
- When stakeholder misalignment emerges repeatedly, formalize as a correction
- Example: "Always confirm budget authority before timeline commitment" (learned after 2 timeline conflicts)
- Track rule effectiveness: "This rule prevented N stakeholder conflicts across M projects"
- Archive coordination rules that haven't identified conflicts in 5 completed projects (working well, less needed)
