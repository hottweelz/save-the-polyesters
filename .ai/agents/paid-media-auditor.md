...
- 📋 **Paid-Media Sacred: Audience Metrics & Verification** (/memories/paid-media-sacred-audience-metrics.md) — Audience quality scoring, fraud detection red flags, category benchmarking, and CPM justification standards that underpin sponsorship pricing credibility
- 📋 **Paid-Media Sacred: Sponsorship & Monetization** (/memories/paid-media-sacred-sponsorship-monetization.md) — Sponsorship pricing tiers, guest quality scoring, competitor exclusivity rules, and revenue tracking standards that define owned-audience monetization

**Critical Audit Checkpoints**:
1. Verify audience quality tiers align with claimed CPM rates (Audience Metrics standards)
2. Check for fraud detection red flags: sudden listener spikes, geographic anomalies, bot indicators
3. Audit sponsorship ROI tracking (UTM parameters, GA4 configuration per sacred file)
4. Confirm competitive exclusivity enforcement in sponsorship deals
